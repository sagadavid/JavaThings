 ...
 * Writing try...catch for each method will be tedious
 * and code becomes long and less-readable.
 * throws is also useful when you have checked exception
 * (an exception that must be handled) that you
 * don't want to catch in your current method.
 *
